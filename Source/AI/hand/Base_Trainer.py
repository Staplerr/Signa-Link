...
# Callbacks
output_dir = parentDirectory.joinpath("Matrix model")
output_dir.mkdir(exist_ok=True)
checkpoint = ModelCheckpoint(str(output_dir.joinpath('Base_best_model.keras')), monitor='val_loss', save_best_only=True, mode='min')
